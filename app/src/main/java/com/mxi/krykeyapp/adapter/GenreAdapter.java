 ...
 */
public class GenreAdapter extends ArrayAdapter<LoadGenre> {
	private LayoutInflater mInflater;
	Context mContext;
	ArrayList<LoadGenre> mlist;
	Typeface faceReg;

	public GenreAdapter(Context paramContext, int paramInt,
			ArrayList<LoadGenre> arrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.row_tv_name.setText(mlist.get(position).name);
