 ...
 */
public class CountryAdapter extends ArrayAdapter<LoadCountryTeam> {
	private LayoutInflater mInflater;
	Context mContext;
	ArrayList<LoadCountryTeam> mlist;
	Typeface faceReg;

	public CountryAdapter(Context paramContext, int paramInt,
			ArrayList<LoadCountryTeam> arrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.row_tv_name.setText(mlist.get(position).country);
