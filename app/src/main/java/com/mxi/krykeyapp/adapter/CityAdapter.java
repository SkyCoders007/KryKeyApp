 ...
 */
public class CityAdapter extends ArrayAdapter<LoadCity> {
	private LayoutInflater mInflater;
	Context mContext;
	ArrayList<LoadCity> mlist;
	Typeface faceReg;

	public CityAdapter(Context paramContext, int paramInt,
			ArrayList<LoadCity> arrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.row_tv_name.setText(mlist.get(position).city);
